...
import { PageComponent } from '@shared/components/public-api';
...
import { DatasourceData, DatasourceType, WidgetConfig, widgetType } from '@shared/models/public-api';
import { IWidgetSubscription, WidgetSubscriptionOptions } from '@core/api/widget-api.models';
// import { UtilsService } from '@core/services/utils.service';
import { UtilsService } from '@core/services/public-api';
...
import { EntityRelationsQuery } from '@shared/models/public-api';
// import { AliasFilterType, RelationsQueryFilter } from '@shared/models/alias.models';
import { AliasFilterType, RelationsQueryFilter } from '@shared/models/public-api';
import { EntityFilter } from '@shared/models/query/query.models';

@Component({
  selector: 'altis-entities-hierarchy-widget',
  templateUrl: './altis-entities-hierarchy-widget.component.html',
  styleUrls: ['./altis-entities-hierarchy-widget.component.scss']
})
export class AltisEntitiesHierarchyWidgetComponent extends PageComponent implements OnInit, AfterViewInit {
